...
permalink: /pages/44307d/
---

# Vue 核心基础 [官网传送门](https://v2.cn.vuejs.org/)
...
![Image from alias](~@alias/img/proxy.png)
...
如果回调比较耗时，那么会等一段时间才发生滚动。 添加 .passive
后，则先进行滚动再执行回调。
```
...
![Image from alias](~@alias/img/key.png)
...
![Image from alias](~@alias/img/lifecycle2.png)
